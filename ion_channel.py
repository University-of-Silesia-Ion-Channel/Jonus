...
class IonChannel:
    ...
    ----------
    data : ndarray
        Holds data generated by method ``generate_data``.
    ...
    def calculate_autocorrelation_acf(self, lags=30, title="test"):
        ...
        plot_acf((self.data_transposed[1]), lags=lags, ax=axs[0], fft=True, title='Unmodified autocorrelation')
        # plt.show()
        plot_acf(np.diff(self.data_transposed[1]), lags=lags, ax=axs[1], fft=True, title='Modified autocorrelation')
    ...
    def calculate_autocorrelation_dfa(self, title="test"):
        ...
        """
        a = fu.toAggregated(self.data_transposed[1])
...
class InteractiveIonChannel():
    ...
    def __ion_channel_interactive(self, a, closed_0, closed_1, opened_0, opened_1, D, delta_t, records, random_force, takes_previous, seed, **force_params):
        ...
        self.ion_channel.generate_data(random_force)
